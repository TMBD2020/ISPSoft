...
class CATVCollectionSummeryController extends Controller
{
    ...
    public function index(){
        ...
        return view("back.reports.catv.collection_summery.index",compact("date_from","date_to","zones"));
    }
    ...
    public function searchCollectionReport(Request $request){
        ...
        $collection = Bills::query()
            ->select(DB::raw("sum(receive_amount) as collections,client.zone_id,sum(otc) as conn_fee"))
    ...
    public function downloadPDF(Request $request) {
        ...
        if($operation=="Print"){
            return view('back.reports.catv.collection_summery.collection_pdf',compact('all_collection','operation',"zones"));
        }else{
            $pdf = PDF::loadView('back.reports.catv.collection_summery.collection_pdf', compact('all_collection','operation',"zones"));
