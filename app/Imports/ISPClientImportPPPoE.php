...
class ISPClientImportPPPoE implements ToCollection,WithHeadingRow
{
                ...
                if($boxes) {
                   ...
                   $prefix_id = IdPrefixs::query()->where("ref_id_type_name",2)->where(["company_id"=>\Settings::company_id()])->first();
                    ...
                    if ($prefix_id) {
                        ...
                        $userCount = User::query()->where("user_id", $user_id)->where(["company_id"=>\Settings::company_id()])->count();
                        ...
                        if ($userCount==0) {
                            ...
                            if ($user) {
                                ...
                                $data = [
                                    ...
                                    "pppoe_username" =>  trim($row['pppoe_username']),
                                    "pppoe_password" =>  trim($row['pppoe_password']),
                ...
                Your username: ".$user_id." and Password: ".$password;
                                ...
                                if ($row['previous_bill'] != "" and $row['previous_bill'] > 0) {
                                    if ($newClient) {
                                        ...
                                        $bill["payable_amount"] = $row['previous_bill']?$row['previous_bill']:0;
