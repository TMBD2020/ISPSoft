        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title" id="tabOption">Add PPPoE</h3>
                </div>
                <div class="content-header-right col-md-8 col-12">
                    ...
                    <ul class="nav nav-tabs float-md-right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route("isp-pppoe") }}" >Add PPPoE</a>
                        </li>
                        {{--<li class="nav-item">--}}
                                                ...
                                                <div class="card collapse-icon accordion-icon-rotate right">
                                                    ...
                                                    <div id="collapseB2" class="collapse" aria-labelledby="headingBTwo">
                                                        <div class="card-body" style="border: 1px solid #ddd;border-radius: 10px;">
                                                            <div class="text-center">
                                                                ...
                                                                <a href="{{ asset("app-assets/files/isp_pppoe_client_sheet.xlsx") }}" download="ISP PPPoE Client Sheet"><i class="ft-download"></i> Excel Demo Download</a>
                                                                <br>
                                                                <br>
                                                                <form action="{{ route('isp-client-import') }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input type="hidden" value="pppoe" name="client_type">
                                                    ...
                                                    <div class="card-body" style="padding:0;">
                                                        <form id="DataForm" method="post" class="form-horizontal">
                                                            ...
                                                            <input type="hidden" value="pppoe" name="client">
                                                                ...
                                                                <div class="col-lg-6 col-xs-12  col-md-6 col-sm-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <label for="pppoe_password"
                                                                               class="col-sm-5 control-label">PPPoE Password <span class="text-danger">*</span></label>
