                                        ...
                                        <div class="tab-pane" id="operation" aria-labelledby="base-tab2">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4><span class="operation_type">Add New</span> Package</h4>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <form id="DataForm" method="post">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Profile Name <code>*</code></label>
                                                                    <input type="text" class="form-control"  name="profile_name" id="profile_name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Package Name <code>*</code></label>
                                                                    <input type="text" class="form-control"  name="package_name" id="package_name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Package Price <code>*</code></label>
                                                                    <input type="number" class="form-control"  name="package_price" id="package_price" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Package Bandwidth <code>*</code></label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon">D</div>
                                                                        <input type="number" min="0" class="form-control text-center" id="download" name="download" style="padding: 0">
                                                                        <div class="input-group-addon">U</div>
                                                                        <input type="number" min="0" class="form-control text-center" id="upload" name="upload" style="padding: 0">
                                                                        <div class="input-group-addon">Y</div>
                                                                        <input type="number" min="0" class="form-control text-center" id="youtube" name="youtube" style="padding: 0">
                                                                        <div class="input-group-addon">Q</div>
                                                                        <input type="number" min="0" class="form-control text-center" id="que_type" name="que_type" style="padding: 0">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="package_type">Package Type <code>*</code></label>
                                                                    <input type="radio" name="package_type" value="client" checked> Client
                                                                    <input type="radio" name="package_type" value="reseller" checked> Reseller
                                                                </div>
                                                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response!=0){
                            ...
                            $("#package_price").val(json.package_price);
                            $("#youtube").val(json.youtube);
                            $("#download").val(json.download);
                            $("#upload").val(json.upload);
                            $("#que_type").val(json.que_type);
                            $("input[name='package_type'][value='"+json.package_type+"']").prop("checked",true);
                        }else{
                            toastr.warning( 'Server Error. Try aging!', 'Warning');
                        }
                    }
