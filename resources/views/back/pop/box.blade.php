                                        ...
                                        <div class="tab-pane" id="operation" aria-labelledby="base-tab2">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4><span class="operation_type">Add New</span> Box</h4>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <form id="DataForm" method="post">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Node<code>*</code></label>
                                                                    <select name="ref_node_id" id="ref_node_id" class="form-control">
                                                                        @foreach($nodes as $row)
                                                                        <option value="{{ $row->id }}">{{ $row->node_name }}</option>
                                                                            @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Box Name<code>*</code></label>
                                                                    <input type="text" class="form-control"  name="box_name" id="box_name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Box Location<code>*</code></label>
                                                                    <input type="text" class="form-control"  name="box_location" id="box_location" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Total Port <code>*</code></label>
                                                                    <input type="text" class="form-control"  name="total_port" id="total_port" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Onu Details</label>
                                                                    <input type="text" class="form-control"  name="onu_details" id="onu_details" >
                                                                </div>
                                                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response!=0){
                            ...
                            $("#action").val(2);
                            $("#id").val(json.id);
                            $("#ref_node_id").val(json.ref_node_id).trigger("change");
                            $("#box_name").val(json.box_name);
                            $("#box_location").val(json.box_location);
                            $("#onu_details").val(json.onu_details);
                            $("#total_port").val(json.total_port);
                        }else{
                            toastr.warning( 'Server Error. Try aging!', 'Warning');
                        }
                    }
