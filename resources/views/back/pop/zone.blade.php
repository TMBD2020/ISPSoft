                                                    ...
                                                    <div class="col-lg-6 col-xs-12  col-md-6 col-sm-12">
                                                        <form id="DataForm" method="post">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <input type="hidden" id="zone_type" name="zone_type" value="1">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="ref_network_id">Network Station <span class="text-danger">*</span></label>
                                                                    <select class="form-control select2" name="ref_network_id" id="ref_network_id" required>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2" name="pop_id" id="pop_id" required>
                                                                        @foreach($pops as $row)
                                                                            <option value="{{ $row->id }}">{{ $row->pop_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="zone_thana">Zone Thana <span class="text-danger"></span></label>
                                                                    <input type="text" class="form-control"  name="zone_thana" id="zone_thana">
                                                                </div>
                                                                <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response!=0){
                            ...
                            $("#zone_thana").val(json.zone_thana);
