                                                        ...
                                                        <form id="DataForm" method="post">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Template Name<code>*</code></label>
                                                                    <input type="text" class="form-control"  name="template_name" id="template_name" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">SMS Category<code>*</code></label>
                                                                   <select  class="form-control"  name="template_type" id="template_type">
                                                                       @foreach(config('constants.sms_template_category') as $row)
                                                                            <option value="{{$row}}">{{$row}}</option>
                                                                       @endforeach
                                                                   </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="template_text">Template Text<code>*</code></label>
                                                                    <textarea class="form-control"  name="template_text" id="template_text" rows="10" required></textarea>
                                                                </div>
                                                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response!=0){
                            ...
                            $("#template_text").val(json.template_text);
                        }else{
                            toastr.warning( 'Server Error. Try again!', 'Warning');
                        }
                    }
