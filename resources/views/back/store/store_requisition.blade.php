                                            ...
                                            <form id="purchaseForm" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select class="form-control select2" multiple name="ticket_no[]" id="ticket_no" required>
                                                            <option value=""></option>
                                                            @foreach($tickets as $ticket)
                                                                <option value="{{ $ticket->ticket_no }}">{{ $ticket->ticket_no  }} [ {{$ticket->subject}} ]</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div  class="col-md-12"><br></div>
            ...
            $(document).on('change', "#product_id", function () {
                ...
                if(id){
                    if (myproduct.indexOf(id) == -1) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('get_available_product') }}",
