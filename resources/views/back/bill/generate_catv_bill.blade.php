...
@section('title', 'Generate CATV Client Bill')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title"><span id="tabOption">Generate CATV Bill</span></h3>
            </div>
                                                        ...
                                                        <form id="DataForm" method="post" >
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" value="{{ $month_year }}" class="form-control" readonly>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <button type="submit" class="btn btn-primary mt-1 mb-0 save">Generate Bill</button>
                                                        </form>
                                                        <div id="console"></div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('submit', "#DataForm", function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('generate-catv-client-bill') }}",
                    ...
                    success: function (response)
                    {
                        ...
                        $(".save").text("Generate Bill").prop("disabled", false);
