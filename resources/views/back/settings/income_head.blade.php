                                                        ...
                                                        <form id="DataForm" method="post">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Income Head Name<code>*</code></label>
                                                                    <input type="text" class="form-control"  name="income_head_name" id="income_head_name" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="expense_head_note">Head Description<code>*</code></label>
                                                                    <textarea class="form-control"  name="income_head_note" id="income_head_note"></textarea>
                                                                </div>
                                                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response!=0){
                            ...
                            $("#action").val(2);
                            $("#id").val(json.id);
                            $("#income_head_name").val(json.income_head_name);
                            $("#income_head_note").val(json.income_head_note);
                        }else{
                            toastr.warning( 'Server Error. Try again!', 'Warning');
                        }
                    }
