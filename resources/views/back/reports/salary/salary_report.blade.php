                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div id="collapseB2" class="" aria-labelledby="headingBTwo">
                                            <div class="card-body" style="padding: 6px 10px;">
                                                <form  method="post" novalidate action="{{ route("salary-report") }}">
                                                    {{csrf_field()}}
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                        </div>
                                                ...
                                                <table class="rptTbl">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 40%;" class="text-center">ID/Name/Mobile</th>
                                                    ...
                                                    @endphp
                                                        @foreach($due_bills as $key=>$data)
                                                            @php
                                                            $pay=$data->emp_salary - ($data->emp_late_fine+$data->emp_absent_fine+$data->emp_others_fine+$data->advance_deduction);
                                                            $total_payable += $pay;
                                                            @endphp
                                                            <tr>
                                                                <td class="text-center">{{ $key+1 }}</td>
                                                                <td><span style="font-size: 12px;">{{ $data->emp->emp_id }}</span> <br>{{ $data->emp->emp_name }}<br>{{ $data->emp->emp_mobile }}</td>

                                                                <td class="text-left">{{ $data->emp->designation->designation_name }}</td>
