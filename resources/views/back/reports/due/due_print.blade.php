            ...
            <td colspan="2">
               ...
               <table>
                ...
                <table class="table">
                    ...
                    $total_payable = 0;
                    @endphp
                    @foreach($data['due_bills'] as $key=>$row)
                        <tr>
                            <td class="text-center">{{ $key+1 }}</td>
                            <td>{{ $row->username }}/ {{ $row->client_name }}</td>
                            <td>{{ $row->cell_no }}</td>
                            <td class="text-left">{{ $row->address }}</td>
                            <td class="text-center">{{ $row->package_name }}</td>
                            <td class="text-left">{{ $row->zone_name_en?$row->zone_name_en:'' }}</td>
                            <td class="text-center">{{ $row->termination_date=='0000-00-00'?'':$row->termination_date }}</td>
