                                        ...
                                        <div class="card inner-card expense_show" style="display: none;">
                                            <div class="card-body" style="padding: 6px 10px;">
                                                <div class="pull-right" style="clear:both; overflow: hidden;">
                                                    <form id="OPform" action="{{ route("client-collection-summery-pdf") }}" method="post" target="_blank">
                                                        @csrf
                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 15%" class="text-center">Total Signup Charge</th>
    ...
    <script type="text/javascript">
        ...
        function search(){
            if($("#date_from").val()!=""  && $("#date_to").val()!=""){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('search_client_collection_summery') }}",
                    data: {
                        _token      : "{{ csrf_token() }}" ,
                        ...
                        if(collection!=0){
                            ...
                            $.each(collection, function(key,value){
                                ...
                                html+='<tr>' +
                                        ...
                                        '<td class="text-left">'+value.zone_name+'</td>' +
