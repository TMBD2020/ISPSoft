...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset("app-assets/css/dataTables.dataTables.min.css")}}">
    <!-- BEGIN: Theme CSS-->
...
<!-- END: Head-->
<!-- BEGIN: Body-->
<body onpaste="fnOnPaste()" class="vertical-layout vertical-menu 2-columns fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
    ...
    @elseif(Auth::user()->user_type=="reseller")
        @include("layouts.sidebar.reseller")
    @else
