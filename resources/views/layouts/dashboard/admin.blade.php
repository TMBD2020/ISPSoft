                        ...
                        <div class="card bg-gradient-x-blue-green">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-white">Previous <span class="previous_catv_bills text-black float-right"></span></h6>
                                    <h6 class="text-white">Current <span class="present_catv_bills text-black float-right"></span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-gradient-x-orange-yellow">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-white">Previous <span class="previous_catv_res_bills text-black float-right">0</span></h6>
                                    <h6 class="text-white">Current <span class="present_catv_res_bills text-black float-right">0</span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section("page_script")
    ...
    <script type="text/javascript">
            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    success: function (response) {
                        var json = (response);
                        //console.log(json.graph_payment[0].receive)
                        ...
                        $(".previous_catv_bills").html(json.previous_catv_bills == null?0:json.previous_catv_bills);
                        $(".present_catv_bills").html(json.catv_present_bills == null?0:json.catv_present_bills);
                        ispClientGraph(json);
                        ispCollection(json);
                    },
        ...
        function ispCollection(json){
            var category=[],
             categoryData=[];
            $.each(json.graph_payment,function(key,value){
                category.push(value.payment);
                categoryData.push(value.receive);
            });
           // console.log(categoryData);
            Highcharts.chart('ispCollection', {
                ...
                title: {
                    text: 'ISP Collection By Payment Method'
                },
                tooltip: {
                    shared: true
                },
...
//                                        align: 'center',
        ...
        function getMemberOfStatus(status){
            ...
            window.location.href="{{ route('isp-clients')}}";
        }
    </script>
@endsection