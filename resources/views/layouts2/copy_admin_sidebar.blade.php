    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{ asset("app-assets/images/backgrounds/02.jpg") }}">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route("dashboard") }}"><img class="brand-logo" src="{{ asset(Settings::settings()['company_logo']) }}"/>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(Permission::check(4,0,"read_access"))
            ...
            <li class=" nav-item
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ (request()->is('box-list')) ? 'active' : '' }}"><a class="menu-item"  href="{{ route("box-list") }}">Sub Node List</a></li>
            ...
            <li class=" nav-item
                ...
                <ul class="menu-content">
                    <li class="{{ (request()->is('catv-station-excel')) ? 'active' : '' }}"><a class="menu-item"  href="{{ route("catv-station-excel") }}">Import/Export</a></li>
                    <li class="{{ (request()->is('catv-zone')) ? 'active' : '' }}"><a class="menu-item"  href="{{ route("catv-zone") }}">Zone</a></li>
                    <li class="{{ (request()->is('catv-sub-zone')) ? 'active' : '' }}"><a class="menu-item"  href="{{ route("catv-sub-zone") }}">Sub Zone</a></li>
                    <li class="{{ (request()->is('catv-package')) ? 'active' : '' }}"><a class="menu-item"  href="{{ route("catv-package") }}">Package</a></li>
                </ul>
            </li>
            ...
            <li class=" nav-item
                ...
                || request()->is('resellers')
                ) open  @endif
                    ">
                <a href="#"><i class="ft-users"></i><span class="menu-title">Clients</span></a>
                <ul class="menu-content">
                    <li class="{{ (request()->is('isp-clients')) ? 'active' : '' }}"><a class="menu-item " href="{{ url("isp-clients") }}">ISP Clients</a> </li>
                    <li class="{{ (request()->is('catv-clients')) ? 'active' : '' }}"><a class="menu-item " href="{{ url("catv-clients") }}">CATV Clients</a> </li>
                    <li class="{{ (request()->is('resellers')) ? 'active' : '' }}"><a class="menu-item" href="{{ route("resellers") }}">Resellers</a> </li>
                </ul>
            </li>
            <li class=" nav-item
                @if(
